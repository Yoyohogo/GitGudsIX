...
public class Mergesort2 {
    ...
    /**
     * This method creates an array filled with random values and sorts them
     * PRE: args 
     * POST: prints unsorted and sorted array 
     */
    public static void main(String[] args) {
        
        //Create and print the original unsorted list
        System.out.print("List:");
        int[] list = new int[(int) (10000)]; //Set the number of items to be sorted
        for (int i = 0; i < list.length; i++) {
            list[i] = (int) (Math.random() * 99 + 1); //Set the values of the numbers to be sorted
    ...
    /**
     * This method divides the list into a right and left half 
     * PRE: list
     * POST: returns a sorted section of the list (or the entire sorted list)
     */
    ...
    /**
     * This method combines the left and right side of the list into a single sorted list
     * PRE: tempR, tempL, length
     * POST: returns a sorted combined list of tempR and tempL
     */
    private static int[] mergesort(int[] tempR, int[] tempL, int length) {
        ...
        int r = 0;
        int l = 0;
        //uncomment this if you would like to see number of comparisons
        //int comparisons = 0;
        String done = "false";
        ...
        //print number of comparisons. note that this considerably extends length of time
        //for program to run
